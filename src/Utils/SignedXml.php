...
class SignedXml
{
     ...
     */
    protected $canonicalMethod = XMLSecurityDSig::C14N_COMMENTS;
    ...
    public function sign(DOMDocument $data)
    {
        ...
        // $sig_properties = $data->createElement("SignatureProperties");
        // $SignatureProperty = $data->createElement("SignatureProperty");
        // $SignatureProperty_id = $data->createAttribute('Id');
        // $SignatureProperty_id->value = "TIMESTAMP1";
        // $SignatureProperty_target = $data->createAttribute('Target');
        // $SignatureProperty_target->value = "#DSIG1";
        // $SignatureProperty->appendChild($SignatureProperty_id);
        // $SignatureProperty->appendChild($SignatureProperty_target);
        //
        // $SigningTime = $data->createElement("SigningTime");
        // $SigningTime_ns = $data->createAttribute("xmlns");
        // $SigningTime_ns->value= "http://www.ietf.org/rfc/rfc3369.txt#";
        // $SigningTime->appendChild($SigningTime_ns);
        // $GeneralizedTime = $data->createElement("GeneralizedTime",date("YmdHisO"));
        // $SigningTime->appendChild($GeneralizedTime);
        // $SignatureProperty->appendChild($SigningTime);
        // $sig_properties->appendChild($SignatureProperty);
        // $objXMLSecDSig->addObject($sig_properties);
        // $objXMLSecDSig->addReference($SignatureProperty, $this->digestAlgorithm, null, ['overwrite' => false]);
